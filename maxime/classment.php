...
function getByConference(){
    ...
    $urlRequest= "https://api.mysportsfeeds.com/v1.1/pull/nhl/$seasonName/conference_team_standings.json?teamstats=W,L,OTW,OTL";
    //print $urlRequest;
            ...
            <table class=\"table table-hover\">
              ...
              <tbody>";
                    ...
                    foreach($teamEntry as $entry){
                        ...
                        $gameWin = $entry['stats']['stats']['Wins']['#text'];
                        $gameLosse = $entry['stats']['stats']['Losses']['#text'];
                        $overTimeWins = $entry['stats']['stats']['OvertimeWins']['#text'];
                        $overTimeLosses = $entry['stats']['stats']['OvertimeLosses']['#text'];
...
function getOverAll(){
    ...
    $urlRequest= "https://api.mysportsfeeds.com/v1.1/pull/nhl/$seasonName/overall_team_standings.json?teamstats=W,L,OTW,OTL";
    //print $urlRequest;
